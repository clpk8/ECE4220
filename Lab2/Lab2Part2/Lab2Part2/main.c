...
void writeArray(void* ptr){
    ...
    //try
    itval.it_interval.tv_nsec = 1500000;    // check the data type
...
void readFile1(void* ptr){
    ...
    itval.it_interval.tv_sec = 0;        // check the data type
    //try
    itval.it_interval.tv_nsec = 3000000;    // check the data type
...
int main(int argc, const char * argv[]) {
    ...
    f2.timeInNanoSecond = 1501000;
    f3.timeInNanoSecond = 751000;
